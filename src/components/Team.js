...
const Team = () => {
  return (
    <section className="container mx-auto px-5 md:px-16 lg:px-24 relative">
      ...
      <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-8 sm:gap-8 mt-16 relative">
        <div className="absolute left-[600px] top-0 flex flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-center mx-auto">
          {/* Team Card */}
          <img
            src="/team/img-1.jpeg"
            alt="Founder"
            className="w-40 h-40 rounded-full object-cover mb-4 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64" // Responsive image sizes
          />
